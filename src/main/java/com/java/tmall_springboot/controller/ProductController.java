package com.java.tmall_springboot.controller;

import com.java.tmall_springboot.pojo.Product;
import com.java.tmall_springboot.pojo.ProductImage;
import com.java.tmall_springboot.service.CategoryService;
import com.java.tmall_springboot.service.ProductImageService;
import com.java.tmall_springboot.service.ProductService;
...
public class ProductController {
    ...
    public Page4Navigator<Product> list(@PathVariable("cid") int cid, @RequestParam(value = "start", defaultValue = "0") int start, @RequestParam(value = "size", defaultValue = "5") int size) throws Exception {
        ...
        productImageService.setFirstProdutcImages(page.getContent());
        return page;
    }
